...
import { Server, Globe, Globe2, CreditCard, Plus } from 'lucide-react';
          ...
          <div className="divide-y divide-gray-100">
            {(!services || services.length === 0) ? (
              <div className="p-12 text-center">
                ...
                <p className="text-sm font-medium text-gray-700 mb-1">No websites yet</p>
                <p className="text-xs text-gray-400 mb-4">Create your first site to get started.</p>
                <Link href="/dashboard/add-site" className="btn-primary text-sm inline-flex items-center gap-1.5"><Plus className="w-4 h-4" /> Add Site</Link>
              </div>
            ) : services.map((s: any) => (
        ...
        <div className="card">
          ...
          <div className="divide-y divide-gray-100">
            {(!domains || domains.length === 0) ? (
              <div className="p-12 text-center">
                <Globe2 className="w-10 h-10 text-gray-300 mx-auto mb-3" />
                <p className="text-sm font-medium text-gray-700 mb-1">No domains registered</p>
                <p className="text-xs text-gray-400 mb-4">Register a domain for your website.</p>
                <Link href="/dashboard/domains/register" className="btn-primary text-sm inline-flex items-center gap-1.5"><Plus className="w-4 h-4" /> Register Domain</Link>
              </div>
            ) : domains.map((d: any) => (
