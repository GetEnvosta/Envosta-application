...
import { ArrowLeft, Globe, Server, ExternalLink, Settings, Network } from 'lucide-react';
...
export default async function DomainDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const tabs: TabDef[] = [
    { id: 'settings', label: 'Settings', icon: <Settings className="w-4 h-4" />, content: settingsPanel },
    { id: 'dns', label: 'DNS & Nameservers', icon: <Network className="w-4 h-4" />, content: dnsPanel },
  ];
  ...
  return (
    <div>
      ...
      <div className="card p-0 overflow-hidden">
        ...
        {/* Tabbed management (settings + DNS) */}
