...
export default async function BillingPage() {
  ...
  const stats = [
    ...
    { label: 'Paid invoices', value: paidInvoicesCount ?? 0, icon: Receipt },
    { label: 'Outstanding invoices', value: outstandingInvoicesCount ?? 0, icon: AlertCircle, sub: 'Open or draft' },
  ];
