...
export const metadata: Metadata = {
  title: 'Envosta v2 — Design Preview',
  description: 'V2 design preview — enterprise-grade WordPress hosting powered by WP.cloud.',
};
  ...
  return (
    <>
      ...
      <div className="zone zone-a">
        ...
        {/* ═══ SECTION 3 — METRICS ═══ */}
        <section id="section-metrics" className="section-pad-sm">
          <div className="c">
        ...
        <section id="section-proof" className="section-pad-sm">
          <div className="c">
            <TestimonialCarousel />
