...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://envosta.com/v2/plans' },
};
            ...
            {plans.map((plan) => {
              ...
              return (
                <div key={plan.key} className={`panel pl-card${flagship ? ' pl-card--flagship' : ''}`}>
                  ...
                  <Link href="/v2/scorecard" className={`btn ${flagship ? 'btn--primary' : 'btn--ghost'}`}>
      ...
      <section className="pl-sla" style={{ paddingTop: 0 }}>
        <div className="wrap">
          ...
          <p style={{ marginTop: 16, fontSize: '.85rem' }}>
            ...
            <Link href="/v2/service-promise" style={{ color: 'var(--amber)' }}>
