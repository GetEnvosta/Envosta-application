...
export async function POST(req: Request) {
  ...
  const metadata = type === 'hosting_plan'
    ? { php_workers_default: 3, php_workers_included: 3, php_memory_mb: 512, storage_gb: 50, has_staging: true, has_backups: true, has_cdn: true, has_waf: true, onboarding_type: 'standard', support_type: 'tickets' }
    : {};
