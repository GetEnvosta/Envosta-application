...
<style>
  ...
  .logo{font-size:20px;font-weight:300;color:#111;letter-spacing:-.5px;margin-bottom:32px}.logo span{font-weight:500}
...
<div class="wrap"><div class="card"><div class="logo">Env<span>o</span>sta</div>${content}</div>
