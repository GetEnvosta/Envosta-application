    ...
    <div className="flex gap-6 min-h-[500px]">
      ...
      <div className="w-56 shrink-0 border-r border-gray-100 pr-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => setAddingPage(true)} className="p-1 rounded-md text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors" title="Add page">
        ...
        {addingPage && (
          <div className="mt-2 space-y-2">
            <input type="text" autoFocus value={newPageTitle}
      ...
      <div className="flex-1 min-w-0">
        {selectedPage ? (
          <div className="space-y-4">
            <input type="text" value={selectedPage.title}
            ...
            <div>
              ...
              <textarea value={selectedPage.prompt || ''}
            ...
            <div className="flex items-center gap-3">
              <button onClick={handleGenerate} disabled={generating || !selectedPage.prompt?.trim()}
                ...
                {generating ? (<><Loader2 className="w-4 h-4 animate-spin" /> Generating...</>) : (<><Sparkles className="w-4 h-4" /> {selectedPage.html ? 'Regenerate' : 'Generate with AI'}</>)}
              </button>
              {status && (
            ...
            {selectedPage.html && (
              <div>
                ...
                <textarea value={selectedPage.html}
